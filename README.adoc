...
[source,shell]
----
cd ${GOPATH}/src/github.com/mayadata-io/kiali/operator
...
If you do not have a JIRA account, you can also https://github.com/mayadata-io/kiali/issues[open issues here on GitHub] (we are monitoring this as well) for any bugs or problems you encounter or to suggest new features.
